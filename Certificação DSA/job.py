...
# Função para remover ponto nos dados da última coluna
...
with open('producao_alimentos.csv', 'r') as file:
    ...
    # Pula a primeira linha, que contém cabeçalhos das colunas
    next(reader)
    ...
    # Cria uma nova tabela para armzenar os dados de produção de alimentos
    ...
    for row in reader:
        if int(row[1]) > 10:
            ...
            # Calcula margem de lucro bruta com base no valor médio de venda e na receita total e arredonda para duas casas decimais
